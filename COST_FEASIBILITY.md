...
**Total incremental:** ₹0 hardware, ~2 days to provision 3 stations. Scales to N stations — schema `station_id` filter, no rebuild. Rust rewrite (`tokio`/`ort`) planned for RPi-class hardening, not required this round (PLAN §11).
