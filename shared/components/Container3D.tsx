    ...
    <div className="w-full flex flex-col gap-3">
      ...
      <div className="w-full h-72 sm:h-80 bg-slate-950/80 rounded-2xl overflow-hidden relative border border-white/10 shadow-inner">
        ...
        <div className="absolute bottom-3 left-3 z-10 flex items-center gap-3 text-[10px] text-white/60 pointer-events-none bg-black/60 backdrop-blur px-2.5 py-1 rounded-full border border-white/10">
          <span className="flex items-center gap-1"><span className="w-2 h-2 rounded-full bg-[#10B981]" /> {legendVariant === 'normal' ? 'Normal' : 'Stocked'}</span>
          <span className="flex items-center gap-1"><span className="w-2 h-2 rounded-full bg-[#F97316]" /> {legendVariant === 'normal' ? 'Low Stock' : 'Low'}</span>
          ...
          <div className="flex items-center justify-between border-b border-white/10 pb-2.5 mb-3">
            <div className="flex items-center gap-2">
              ...
              <span className="text-xs text-white/50">
                {selectedCrateAssets.length} asset{selectedCrateAssets.length !== 1 ? 's' : ''} {legendVariant === 'normal' ? 'stored' : 'inside'}
              </span>
            </div>
            <button
