...
export const SEED_ASSETS = [
  ...
  { id: 'A3', sku: 'O2-CYL-47L-003', name: 'Oxygen Cylinder 47L', category: 'OXYGEN', qty: 24, unit: 'cyl', expiry_date: '2026-11-15', criticality: 'CRITICAL', crate_id: 'C2-K1', barcode: 'O2-CYL-47L-003' },
  ...
  { id: 'A5', sku: 'MED-ANTIBIOTIC-005', name: 'Antibiotic Kit (Amoxicillin)', category: 'MEDICAL', qty: 12, unit: 'kits', expiry_date: '2026-09-21', criticality: 'CRITICAL', crate_id: 'C2-K3', barcode: 'MED-ANTIBIOTIC-005' },
  { id: 'A6', sku: 'MED-TRAUMA-006', name: 'Trauma Kit (Type A)', category: 'MEDICAL', qty: 6, unit: 'kits', expiry_date: '2026-10-11', criticality: 'CRITICAL', crate_id: 'C2-K3', barcode: 'MED-TRAUMA-006' },
